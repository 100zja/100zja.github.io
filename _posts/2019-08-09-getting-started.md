...
![memory structure](C:\Users\USER\Pictures\image\메모리_구조.png)
...
* **stack** : 
![stack](C:\Users\USER\Pictures\image\stack.png)
*  후입선출 구조 이용    
  - 제일 위의 데이터만 알 수 있다  
...
![system flags](C:\Users\USER\Pictures\image\system_flags.png)
